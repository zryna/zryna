...
const LANE_PATHS = Object.freeze({
  ...
  distribution_release: Object.freeze([
    ...
    /^tests\/distribution-(?:archive|inventory|source-receipt|receipt-compatibility|schema|payload)\.test\.mjs$/,
    ...
    /^spec\/release\//,
    /^tests\/(?:(?:distribution-(?:release|build-input)|source-build-receipt|preassembly-gates)-v1|distribution-release-producers)\.test\.mjs$/,
  ]),
