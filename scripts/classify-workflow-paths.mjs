...
const LANE_PATHS = Object.freeze({
  ...
  distribution_release: Object.freeze([
    /^schemas\/zryna-(?:distribution-(?:release|build-input)|source-build-receipt)-v1\.schema\.json$/,
    /^scripts\/distribution-release\//,
    /^spec\/release\//,
    /^tests\/(?:distribution-(?:release|build-input)|source-build-receipt)-v1\.test\.mjs$/,
  ]),
