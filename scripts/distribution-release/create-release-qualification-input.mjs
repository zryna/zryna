...
export function createReleaseQualificationInput({
  ...
  return validateReleaseQualificationInput({
    ...
    status: 'provisional-candidate', productionAdmission: 'forbidden', versionCandidate: '0.2.3',
    ...
    archive: windows
      ? { format: 'zip', root: `zryna-qualification-0.2.3-${target}-${source.source.commit.slice(0, 12)}`,
        method: 'store', creator: 'unix-2.0', timestamp: '1980-01-01T00:00:00',
        extraFields: false, comments: false }
      : { format: 'tar-gzip',
        root: `zryna-qualification-0.2.3-${target}-${source.source.commit.slice(0, 12)}`,
