...
| `mixed_copy_operators.rs`, `scalar_operator_matrix.rs` | All ten scalar operations, Bool/i32 equality, ordered nested operands, exact result mismatch and competing operand diagnostics through the existing checker. |
