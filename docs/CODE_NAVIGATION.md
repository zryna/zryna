...
- Native lexical entry: `crates/zryna-frontend/src/native_lexer.rs`; this is a source-bound partial stage only, before parsing, snapshot construction, provider handshake, or selection.
