...
closure implemented, straight-line modules/scopes/types/calls lower to verified M2 IR, and the
isolated IR verifier implemented, but the M2 profile is not executable. Issue #45 freezes the normative
...
without enabling control flow or a backend. None of these boundaries enables a compiler profile,
a CLI command, or a public M2 support claim. `I32V1`, protocol v2, manifest v1, and all M0/M1 executable
