...
| `R1` | #327 | Source-produced block and edge totals admit the exact limit, reject first-extra and checked overflow as stable `ZRYNA-M3201`, preserve failed state and recover on the same lowerer. |
