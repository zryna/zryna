...
/// Normalized type spelling retained for the UTS semantic checker.
#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
...
pub struct ProjectSyntaxSnapshot {
    ...
    /// Provider diagnostics; UTS semantics remain authoritative.
...
/// # Errors
///
/// Returns a protocol mismatch when the provider does not speak the required UTS contract.
