...
use owned_string_lowering::{PrivateStringLowerer, StringBranchTypes};
use owner_state::{
...
use string_vec_resource_estimates::{
    ...
    cleanup_actions_after_transfer, empty_owned_string_estimate, estimate_owned_string_expression,
