...
use root_borrow_value_planning::{plan_root_borrow_initializer, plan_root_borrow_place};
#[cfg(test)]
...
use type_model::{
    ...
    RootBorrowLiteral, RootBorrowPlacePlan, RootBorrowPlan, RootBorrowProjectionKey,
    RootBorrowResources, RootBorrowShape, RootBorrowStep, TerminalOwnedIf, Ty, apply_owner_delta,
    map_node_types,
};
