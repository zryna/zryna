use super::*;
use zryna_syntax::v4::{
    RawDataDeclaration, RawDataDeclarationKind, RawDataField, RawElseSyntax, RawEnumVariant,
};
...
pub(in crate::data_ownership_v1) fn fixture(
    ...
    let declarations = declarations(&mut c.f, payload);
...
fn declarations(f: &mut Builder, payload: Payload) -> Vec<RawDataDeclaration> {
    match payload {
