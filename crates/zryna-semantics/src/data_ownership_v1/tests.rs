use super::{
    ...
    generated_cfg_budget_violation, is_terminal_owned_phi_candidate, lower,
    owned_call_cleanup_budget_violation, owned_cfg_budget_violation, owned_place_budget_violation,
    owned_value_budget_violation, partial_assignment_budget_preflight,
    ...
    preflight_owned_string_preparation, projected_aggregate_assignment_budget_violation,
    ...
    raw_terminator_edge_count, resource_budget_violation, root_borrow_resource_violation,
    semantic_preflight, span, straight_root_borrow_budget_violation, string_byte_budget_violation,
...
fn owned_enum_payload_move_resource_preflight_accepts_exact_place_limit_only() {
    assert_eq!(
        ...
        super::EnumPayloadMoveResourceEstimate {
            blocks: 3,
            edges: 2,
            values: 3,
            places: 7,
