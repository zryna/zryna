use super::{
    ...
    generated_cfg_budget_violation, is_terminal_owned_phi_candidate, loop_root_borrow_resources,
    lower, owned_call_cleanup_budget_violation, owned_cfg_budget_violation,
