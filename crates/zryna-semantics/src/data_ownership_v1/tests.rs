use super::aggregate_resource_formulas::{
...
pub(in crate::data_ownership_v1) mod mixed_copy_operators;
pub(in crate::data_ownership_v1) mod mixed_disjoint_owned_sibling;
...
use super::global_resource_limits::{
    ...
    resource_budget_violation, string_byte_budget_violation, value_budget_violation,
};
use super::owned_cfg_state::OwnedCfgState;
use super::owned_control_flow_resources::{
    EnumPayloadMoveResourceEstimate, OwnedCfgBudgetLimit, conditional_root_borrow_budget_violation,
    conditional_root_borrow_resources, dense_owned_value_id, enum_payload_move_resource_estimate,
    loop_root_borrow_resources, owned_cfg_budget_violation, owned_place_budget_violation,
...
mod partial_struct_transfer_fixture_support;
mod partial_struct_transfers;
mod private_aggregate_lowering;
mod private_loop_cleanup_budgets;
mod private_loop_core;
mod private_string_if;
mod private_string_mutation_loop;
mod private_vec_if;
mod projected_aggregate_assignments;
mod projected_aggregate_fixture_data;
mod projected_aggregate_fixture_support;
mod projected_aggregate_validation;
...
use aggregate_fixture_support::{
    ...
    fixed_array_field_wrong_base_snapshot, owned_pair_projected_return_snapshot,
    struct_index_wrong_base_snapshot,
};
use aggregate_root_assignment_fixture_support::{
    OwnedPairAssignmentRhs, OwnedPairProjectionAssignmentRhs, owned_enum_assignment_snapshot,
    owned_pair_assignment_snapshot, owned_pair_projection_assignment_snapshot,
};
use common_fixture_support::{
    nth_untrusted_span, pair_input, pair_sources, response_snapshot, shift_snapshot,
    shift_snapshot_signed, sources_for, untrusted_range,
};
use fault_oracle_support::{
    OwnedFaultDisposition, OwnedFaultInjection, OwnedFaultOracleError, assert_all_runtime_faults,
    owned_fault_trace,
};
use fixed_array_partial_fixture_support::{
    OwnedArrayProjectionCase, fixed_array_oob_assignment_snapshot,
    owned_array_partial_local_transfer_snapshot, owned_array_projected_clone_return_snapshot,
    owned_array_projected_return_snapshot,
};
...
use nested_partial_transfer_fixture_support::{
    nested_owned_partial_local_transfer_snapshot, nested_owned_partial_return_snapshot,
};
...
use partial_struct_transfer_fixture_support::{
    owned_pair_partial_local_transfer_snapshot,
    owned_pair_partial_transfer_then_use_source_snapshot,
    owned_pair_repeated_partial_local_transfer_snapshot,
};
use private_loop_cleanup_budgets::private_string_branch_budget_lowerer;
use private_string_mutation_loop::{
    StringLoopReplacement, private_string_mutation_loop_fixture_with_options,
};
use projected_aggregate_fixture_support::{
    FIXED_ARRAY_SUBOBJECT_ASSIGNMENT_RESPONSE, FIXED_ARRAY_SUBOBJECT_ASSIGNMENT_SOURCE,
    FIXED_ARRAY_SUBOBJECT_CLONE_ASSIGNMENT_RESPONSE, FIXED_ARRAY_SUBOBJECT_CLONE_ASSIGNMENT_SOURCE,
    FIXED_ARRAY_SUBOBJECT_RETURN_RESPONSE, FIXED_ARRAY_SUBOBJECT_RETURN_SOURCE,
    PROJECTED_AGGREGATE_ASSIGNMENT_RESPONSE, PROJECTED_AGGREGATE_ASSIGNMENT_SOURCE,
    PROJECTED_ARRAY_ELEMENT_MOVE_RESPONSE, PROJECTED_ARRAY_ELEMENT_MOVE_SOURCE,
    PROJECTED_INNER_DIRECT_RETURN_RESPONSE, PROJECTED_INNER_DIRECT_RETURN_SOURCE,
    PROJECTED_INNER_MOVE_RESPONSE, PROJECTED_INNER_MOVE_SOURCE,
    PROJECTED_SUBOBJECT_ASSIGNMENT_RESPONSE, PROJECTED_SUBOBJECT_ASSIGNMENT_SOURCE,
    PROJECTED_SUBOBJECT_CLONE_AFTER_MOVE_RESPONSE, PROJECTED_SUBOBJECT_CLONE_AFTER_MOVE_SOURCE,
    PROJECTED_SUBOBJECT_CLONE_ASSIGNMENT_RESPONSE, PROJECTED_SUBOBJECT_CLONE_ASSIGNMENT_SOURCE,
    PROJECTED_SUBOBJECT_CLONE_WITH_PARAMETER_RESPONSE,
    PROJECTED_SUBOBJECT_CLONE_WITH_PARAMETER_SOURCE, clone_final_return_snapshot,
    projected_aggregate_clone_assignment_snapshot,
    projected_aggregate_clone_direct_return_snapshot, projected_aggregate_clone_local_snapshot,
    projected_aggregate_direct_return_with_parameter_snapshot,
    projected_inner_child_after_parent_snapshot, two_projected_aggregate_clone_sites_snapshot,
};
...
use vec_fixture_support::{
    ...
    VEC_PUSH_SOURCE, VEC_STRING_RESPONSE, VEC_STRING_SOURCE, private_vec_clone_fixture,
    private_vec_nested_string_fixture,
};
...
mod checked_chain_source;
mod explicit_indexed_additional;
mod explicit_indexed_call_rejections;
mod explicit_indexed_calls;
pub(in crate::data_ownership_v1) mod explicit_indexed_fixture;
mod explicit_indexed_regions;
