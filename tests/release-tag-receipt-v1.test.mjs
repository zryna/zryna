...
function environment() {
  return {
    ...
    GITHUB_WORKFLOW_REF:
      'zryna/zryna/.github/workflows/release.yml@refs/tags/v0.2.3',
...
function responses() {
  ...
  return new Map([
    ...
    ['show-ref\0--verify\0--hash\0refs/tags/v0.2.3', `${TAG_OBJECT}\n`],
    ...
    ['rev-parse\0refs/tags/v0.2.3^{commit}', `${COMMIT}\n`],
...
test('producer rejects lightweight, nested, dirty, and non-ordinary workflow inputs', () => {
  ...
  const tag = Buffer.from([
    `object ${'e'.repeat(40)}`, 'type tag', 'tag v0.2.3',
...
test('producer rejects workflow context, object-size, and read-size drift', () => {
  ...
  const swapRef = (executable, args, options) => {
    ...
    if (key === 'show-ref\0--verify\0--hash\0refs/tags/v0.2.3' && refReads++ === 1) {
      value = `${'e'.repeat(40)}\n`;
    }
    return {
      status: 0,
