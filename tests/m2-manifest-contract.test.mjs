...
test('the quick gate includes the focused public manifest/profile contract', async () => {
  ...
  assert.equal(
    ...
    'node --test tests/docs-bundle.test.mjs tests/m2-contract.test.mjs tests/m2-manifest-contract.test.mjs tests/m3-contract.test.mjs tests/m3-public-docs.test.mjs',
  );
});
